 ...
 */
 ...
 class Form_tMoeuvre extends Form_GenForm
{
	
	public $has_TinyMce= false;
	public $has_TinyAdvanced=false;
	public $is_ListJson=true;
	public $vectJson=array('codeMetier', 'name');
	 ...
	 */
    protected $_labelForm=Array(array('Code metier', 'text', array('size' => '35', 'control' => 'alphadiac'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => true)), 
    ...
    public $display=Array('title' => array('0'=>'Job ref.', '1'=>'Name', '2' => 'Rate' ),
    					  'value' => array('0'=>'codeMetier', '1' => 'name', '2' =>'rate'));


    public function  __construct($name='tMoeuvre') {  
