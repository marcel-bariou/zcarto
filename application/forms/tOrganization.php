 ...
 */
 ...
 class Form_tOrganization extends Form_GenForm
{
	 ...
	 */
	protected $_cols_not_inform=Array('id', 'comments');
	 ...
	 */	 
    public $display=Array('title' => array('0'=>'Name', '1'=>'City', '2' => 'Country' ),
    					  'value' => array('0'=>'c_name', '1' => 'City', '2' =>'country'));


    public function  __construct($name='tOrganization') {  
    	$options=Array();
    	/*
    	...
    	*/
    	$options = Array(0 => "Cliente", 1 => "Fournisseur", 2 => "Gouvernementale", 3 => "Partenaire", 4 => "Association", 5 => "Coopérative");
