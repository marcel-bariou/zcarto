 ...
 */
 ...
 class Form_tChamp extends Form_GenForm
{
	 ...
	 */
	 ...
	 protected $_labelForm=Array(array('Name', 'text', array('size' => '35', 'control' => 'alphanumvirgapos'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => true)), 
                                array('Client', 'comboBox_Dojo', Array('searchAttrib'=>'username', 'list' =>'tOrganization' ), NULL), 
				...
				array('Alignements', 'textarea',  array('cols' =>'52', 'rows' => '5'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => false)), 
				array('Transverses', 'textarea',  array('cols' =>'52', 'rows' => '5'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => false)), 
				array('Déviations Long.', 'textarea',  array('cols' =>'52', 'rows' => '5'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => false)), 
				array('Déviations Trans.', 'textarea',  array('cols' =>'52', 'rows' => '5'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => false)), 
				array('Cable fin chapelle', 'textarea',  array('cols' =>'52', 'rows' => '5'), array('validators' => array('NotEmpty'), 'filters' => array('StripTags', 'StringTrim'), 'required' => false)), 
 				...
 				array('NomXml', 'select', array('size' => '40'), NULL),
	 ...
	 */	 
    public $display=Array('title' => array('0'=>'Nom champ', '1' => 'Nom Client', '2'=>'latitude', '3' => 'Longitude' ),
    					  'value' => array('0'=>'c_name', '1' => 'FKid_Client','2' => 'latitude', '3' =>'longitude'));


    public function  __construct($name='tChamp') {  
    	$options2=Array();
    	...
    	$this->_labelForm[16][2]= $options;

    	    	    	
    	$query = 'SELECT id, c_name FROM tNomenclature ';
    	$db1= Zend_Registry::get('db1');
    	$db1->setFetchMode(Zend_Db::FETCH_OBJ);
    	$result = $db1->fetchAll($query);
    	foreach($result as $key => $value){
    		$options2[$result[$key]->id]= $result[$key]->c_name;    	}
    	
    	$this->_labelForm[18][2]= $options2; 
